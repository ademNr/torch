...
const TorchLandingPage = () => {
    ...
    const features = [
        {
            ...
            description: "Our AI-powered technology scans through millions of dating profiles with 98.5% accuracy"
        },
        {
            icon: <Shield className="w-6 h-6 sm:w-8 sm:h-8" />,
            title: "100% Anonymous & Secure",
            description: "Your searches are completely private. We don't store your photos or personal information"
        },
        {
    ...
    const stats = [
        { number: "2.1M+", label: "Profiles Scanned" },
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
            ...
            <div className="relative overflow-hidden">
                ...
                <div className="absolute inset-0 overflow-hidden">
                    <div className="absolute -top-20 -right-20 sm:-top-40 sm:-right-40 w-40 h-40 sm:w-80 sm:h-80 bg-gradient-to-br from-red-500/10 to-orange-500/10 rounded-full blur-3xl animate-pulse"></div>
                    <div className="absolute -bottom-20 -left-20 sm:-bottom-40 sm:-left-40 w-40 h-40 sm:w-80 sm:h-80 bg-gradient-to-br from-orange-500/10 to-red-500/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
                </div>

                <div className="relative max-w-7xl mx-auto px-4 pt-8 pb-16 sm:pt-16 sm:pb-24 sm:px-6 lg:px-8">
                    {/* Navigation */}
                    <nav className="flex items-center justify-between mb-8 sm:mb-16">
                        <div className="flex items-center space-x-2 sm:space-x-3">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-red-500 to-orange-500 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow">
                                <FireIcon size={20} color="white" className="sm:hidden" />
                                <FireIcon size={28} color="white" className="hidden sm:block" />
                            </div>
                        ...
                        <button
                            ...
                            className="sm:hidden p-2 rounded-xl bg-white shadow-lg"
                        >
                            {mobileMenuOpen ? (
                        ...
                        <button
                            ...
                            className="hidden sm:flex items-center px-4 py-2 lg:px-6 lg:py-3 bg-gradient-to-r from-red-500 to-orange-500 text-white rounded-xl lg:rounded-2xl font-semibold text-sm lg:text-base hover:shadow-lg hover:shadow-red-500/25 transition-all duration-300 hover:scale-105"
                        >
                    ...
                    {/* Mobile Menu */}
                    {mobileMenuOpen && (
                        <div className="sm:hidden absolute top-20 left-4 right-4 bg-white rounded-2xl shadow-xl border border-gray-200 z-50 p-4">
                            <button
                                onClick={handleGetStarted}
                    ...
                    <div className="space-y-8 lg:space-y-16">
                        {/* Text Content */}
                        <div className={`text-center lg:text-left space-y-6 sm:space-y-8 ${isVisible ? 'animate-in fade-in slide-in-from-bottom duration-1000' : 'opacity-0'}`}>
                            <div className="space-y-4 sm:space-y-6">
                                <div className="inline-flex items-center px-3 py-2 sm:px-4 bg-gradient-to-r from-red-50 to-orange-50 rounded-xl sm:rounded-2xl border border-red-100">
                                    <FireIcon size={14} color="#ef4444" className="mr-2" />
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
                                <button
                                    onClick={handleGetStarted}
                                    className="group flex items-center justify-center px-6 py-3 sm:px-8 sm:py-4 bg-gradient-to-r from-red-500 to-orange-500 text-white rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg hover:shadow-xl hover:shadow-red-500/25 transition-all duration-300 hover:scale-105"
                                >
                                    <FireIcon size={20} color="white" className="mr-2 sm:mr-3 group-hover:scale-110 transition-transform" />
                            ...
                            {/* Stats */}
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 pt-6 sm:pt-8 border-t border-gray-200 max-w-2xl mx-auto lg:mx-0">
                        ...
                        <div className={`relative ${isVisible ? 'animate-in fade-in slide-in-from-bottom duration-1000 delay-500' : 'opacity-0'}`}>
                            ...
                            <div className="block lg:hidden space-y-8">
                                ...
                                <div className="relative">
                                    <div className="max-w-sm mx-auto bg-white rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden border border-gray-100 transform hover:scale-105 transition-transform duration-300">
                                        {/* Header */}
                                        ...
                                        <div className="p-4 sm:p-6 bg-gray-50">
                                            <div className="text-center mb-4 sm:mb-6">
                                                <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">Let&apos;s find out on Torch</h3>
                                                <p className="text-gray-600 text-xs sm:text-sm">Upload a photo to find out if he/she is using a dating app !!</p>
                                            </div>

                                            {/* Upload area */}
                                            <div className="border-2 border-dashed border-red-300 rounded-xl sm:rounded-2xl p-4 sm:p-8 text-center bg-white mb-4">
                                                ...
                                                <button className="bg-gradient-to-r from-red-500 to-orange-500 text-white px-4 py-2 sm:px-6 rounded-xl font-medium text-xs sm:text-sm flex items-center justify-center mx-auto">
                                ...
                                <div className="flex justify-center py-4">
                                    <div className="flex flex-col items-center space-y-2">
                                        <div className="w-0.5 h-8 bg-gradient-to-b from-red-400 to-orange-400"></div>
                                        <ArrowRight className="w-5 h-5 text-red-500 animate-pulse rotate-90" />
                                        <div className="w-0.5 h-8 bg-gradient-to-b from-red-400 to-orange-400"></div>
                                    </div>
                                </div>
                                ...
                                {showResults && (
                                    <div className="animate-in fade-in slide-in-from-bottom duration-1000">
                                        <div className="relative">
                                            <div className="max-w-sm mx-auto bg-white rounded-2xl sm:rounded-3xl shadow-2xl border border-gray-100 overflow-hidden transform hover:scale-105 transition-transform duration-300">
                                                {/* Header */}
                                                <div className="bg-gradient-to-r from-red-500 to-orange-500 px-3 py-2 sm:px-4 sm:py-3 flex items-center justify-between">
                                                    <div className="flex items-center space-x-2">
                                                        <FireIcon size={14} color="white" />
                                                ...
                                                <div className="p-4 sm:p-6 bg-gray-50">
                                                    ...
                                                    <div className="text-center mb-4 sm:mb-6">
                                                        ...
                                                        <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-1 sm:mb-2">Your Face Recognition Results</h3>
                                                    ...
                                                    <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 mb-4 sm:mb-6 shadow-sm">
                                                        <div className="grid grid-cols-2 gap-3 sm:gap-4">
                                                            <div className="bg-gradient-to-r from-red-50 to-orange-50 rounded-lg sm:rounded-xl p-3 sm:p-4 text-center border border-red-100">
                                                            ...
                                                            <div className="bg-gradient-to-r from-red-50 to-orange-50 rounded-lg sm:rounded-xl p-3 sm:p-4 text-center border border-red-100">
                                                                <div className="text-xl sm:text-2xl font-bold text-gray-900 mb-1">233ms</div>
                                                    ...
                                                    {/* Matches section */}
                                                    <div>
                                                        <h4 className="text-base sm:text-lg font-bold text-gray-900 mb-3 sm:mb-4">Your Matches (1)</h4>
                                                        ...
                                                        <div className="bg-white rounded-xl sm:rounded-2xl overflow-hidden shadow-lg">
                                                            <div className="relative h-32 sm:h-48 bg-gradient-to-br from-gray-300 to-gray-400 overflow-hidden">
                                                                <div className="absolute inset-0 bg-gradient-to-br from-gray-500/50 to-gray-700/50 blur-lg"></div>
                                                                <div className="absolute inset-0 bg-black/20"></div>

                                                                {/* Match percentage badge */}
                                                                <div className="absolute top-2 right-2 sm:top-4 sm:right-4 bg-red-500 text-white px-2 py-1 sm:px-3 rounded-full text-xs sm:text-sm font-bold">
                                                                    92.7% Match
                                                                </div>
                                            ...
                                            {/* Step 2 Label */}
                                            <div className="absolute -bottom-3 left-1/2 transform -translate-x-1/2">
                                                <div className="bg-white rounded-full px-3 py-1 sm:px-4 sm:py-2 shadow-lg border-2 border-green-200">
                                                    <span className="text-green-600 font-semibold text-xs sm:text-sm">Step 2: Results</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="hidden lg:flex items-center justify-center space-x-8 overflow-x-auto pb-8">
                                ...
                                <div className="relative flex-shrink-0">
                                    <div className="w-80 h-auto bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100 transform hover:scale-105 transition-transform duration-300">
                                        ...
                                        <div className="p-6 bg-gray-50">
                                            <div className="text-center mb-6">
                                                <h3 className="text-xl font-bold text-gray-900 mb-2">Lets find out on Torch</h3>
                                                <p className="text-gray-600 text-sm">Upload a photo to find out if he/she is using a dating app !!</p>
                                            </div>

                                            <div className="border-2 border-dashed border-red-300 rounded-2xl p-8 text-center bg-white mb-4">
                                                ...
                                                <button className="bg-gradient-to-r from-red-500 to-orange-500 text-white px-6 py-2 rounded-xl font-medium text-sm flex items-center justify-center mx-auto">
                                ...
                                {showResults && (
                                    <div className="flex-shrink-0 animate-in fade-in slide-in-from-right duration-1000">
                                        <div className="relative">
                                            <div className="w-80 h-auto bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden transform hover:scale-105 transition-transform duration-300">
                                                <div className="bg-gradient-to-r from-red-500 to-orange-500 px-4 py-3 flex items-center justify-between">
                                                    <div className="flex items-center space-x-2">
                                                        <FireIcon size={16} color="white" />
                                                        <span className="text-white font-bold text-sm">Torch</span>
                                                ...
                                                <div className="p-6 bg-gray-50">
                                                    <div className="text-center mb-6">
                                                        ...
                                                        <h3 className="text-lg font-bold text-gray-900 mb-2">Your Face Recognition Results</h3>
                                                    ...
                                                    <div className="bg-white rounded-2xl p-6 mb-6 shadow-sm">
                                                        <div className="grid grid-cols-2 gap-4">
                                                            ...
                                                            <div className="bg-gradient-to-r from-red-50 to-orange-50 rounded-xl p-4 text-center border border-red-100">
                                                                <div className="text-2xl font-bold text-gray-900 mb-1">233ms</div>
                                                                <div className="text-xs text-gray-600">Processing Time</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div>
                                                        <h4 className="text-lg font-bold text-gray-900 mb-4">Your Matches (1)</h4>
                                            ...
                                            <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2">
                                                <div className="bg-white rounded-full px-4 py-2 shadow-lg border-2 border-green-200">
                                                    <span className="text-green-600 font-semibold text-sm">Step 2: Results</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="absolute -top-8 -left-8 w-16 h-16 bg-gradient-to-r from-red-500 to-orange-500 rounded-full flex items-center justify-center shadow-lg animate-pulse">
                                    <Zap className="w-8 h-8 text-white" />
                                </div>

                                <div className="absolute -bottom-8 -right-8 w-12 h-12 bg-gradient-to-r from-orange-500 to-yellow-500 rounded-full flex items-center justify-center shadow-lg">
                        ...
                        {howItWorks.map((item, index) => (
                            <div key={index} className="relative text-center group">
                                <div className="relative mb-4 sm:mb-6">
                                    <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-red-500 to-orange-500 rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-105">
                                        <div className="text-white">
                                            {item.icon}
                                        </div>
                                    </div>
                                    <div className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 w-6 h-6 sm:w-8 sm:h-8 bg-white border-2 border-red-500 rounded-full flex items-center justify-center text-red-500 font-bold text-xs sm:text-sm shadow-md">
                                        {item.step}
                                    </div>
                                </div>
                                ...
                                {index < howItWorks.length - 1 && (
                                    <div className="hidden lg:block absolute top-8 sm:top-10 left-1/2 w-full h-0.5 bg-gradient-to-r from-red-200 to-orange-200 transform translate-x-6"></div>
                                )}
                            </div>
                        ))}
                    </div>
            ...
            {/* Features */}
            <div className="py-16 sm:py-24 bg-gradient-to-br from-gray-50 to-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12 sm:mb-16">
                        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
                        {features.map((feature, index) => (
                            <div key={index} className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-red-200 group hover:-translate-y-1">
                                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-red-50 to-orange-50 rounded-xl sm:rounded-2xl flex items-center justify-center mb-3 sm:mb-4 group-hover:from-red-500 group-hover:to-orange-500 transition-all duration-300">
            ...
            {/* CTA Section */}
            <div className="py-16 sm:py-24 bg-gradient-to-r from-red-500 to-orange-500">
                <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                    <div className="mb-6 sm:mb-8">
                        <FireIcon size={60} color="white" className="sm:hidden mx-auto mb-4 animate-pulse" />
                        <FireIcon size={80} color="white" className="hidden sm:block mx-auto mb-6 animate-pulse" />
                        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-3 sm:mb-4">
                            Ready to Discover the Truth?
                        </h2>
                        <p className="text-base sm:text-lg lg:text-xl text-red-100 max-w-2xl mx-auto px-4 sm:px-0">
                    ...
                    <button
                        onClick={handleGetStarted}
                        className="inline-flex items-center px-6 py-3 sm:px-10 sm:py-5 bg-white text-red-600 rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 group"
                    >
                        <FireIcon size={20} color="#dc2626" className="mr-2 sm:mr-3 group-hover:scale-110 transition-transform" />
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
                        <div className="flex items-center space-x-2 sm:space-x-3">
                            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-red-500 to-orange-500 rounded-lg sm:rounded-xl flex items-center justify-center">
                                <FireIcon size={18} color="white" className="sm:hidden" />
                                <FireIcon size={24} color="white" className="hidden sm:block" />
                            </div>
